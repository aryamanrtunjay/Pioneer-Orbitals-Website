...
export default function InfoCard({ src, alt, title, infoText}) {
  ...
  return (
    ...
    >
      <div className={!open ? "relative rounded-[30px] overflow-hidden outline outline-[1px] outline-[#484848]/[0.45] shadow-[rgba(0,0,0,0.5)_15px_30px_50px_0px] w-auto h-[450px] lg:h-[693px]" 
                            : "relative rounded-[30px] overflow-hidden outline outline-[1px] outline-[#484848]/[0.45] shadow-[rgba(0,0,0,0.5)_15px_0px_50px_0px] w-auto h-[450px] lg:h-[693px]"
                     }
      >
      ...
      <AnimatePresence>
        <motion.div
          ...
          animate={{opacity: open ? 1 : 0, y: open ? -400 : -800 }}
          exit={{opacity: 0, y: -800 }}
          transition={{ duration: 0.2 }}
          className={open ? "relative bg-[#393939] w-full h-[377px] rounded-b-[30px] -translate-y-[20px] z-[-10] bottom-[-377px] flex flex-col gap-10 justify-center items-center"
        ...
        >
          <h1 className="text-[20px] mx-[25px] text-left"> {infoText} </h1>
