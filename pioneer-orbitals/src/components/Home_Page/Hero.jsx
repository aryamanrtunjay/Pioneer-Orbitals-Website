  ...
  return (
    <div className="h-dvh">
      ...
      <div className={style}>
        ...
        <h2 className={isDesktop ? "text-3xl font-medium text-center leading-none" : "text-lg font-light text-center leading-none"}>Innovating small satellite launchers for a brighter future</h2>
