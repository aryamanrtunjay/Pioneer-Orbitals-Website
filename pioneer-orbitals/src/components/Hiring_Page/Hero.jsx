...
export default function Hero() {
  ...
  return (
    <div className="h-[calc(100vh-124px)]">
      ...
      />
      <div className={style}>
        <h1 className={isDesktop ? "text-8xl font-light tracking-widest uppercase text-center" : "mx-0 px-0 text-5xl font-lightest tracking-widest uppercase text-center"}>Join the Team</h1>
      </div>
